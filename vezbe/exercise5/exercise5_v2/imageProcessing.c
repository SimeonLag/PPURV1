...
void average(uint_least8_t* iData, int_least32_t iWidth, int_least32_t iHeight, float* R, float* G, float* B){
...
void mean_filter(uint_least8_t* iData, int_least32_t iWidth, int_least32_t iHeight, uint_least8_t* oData) {
	int_fast8_t i;
	int_fast8_t j;
	int_fast8_t k;
