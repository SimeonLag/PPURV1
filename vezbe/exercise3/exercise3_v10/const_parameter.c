...
void modifyString1(const char* sp)//pokazivac se moze menjati ali sadrzaj ne
{
	modifyChar(sp + 3);
	sp = globalString;
	*(sp + 3) = '\0';
...
void modifyString2(char const* sp)//pokazivac se moze menjati ali sadrzaj ne
{
...
void modifyString3(char* const sp)//pokazivac se ne moze menjati ali sadrzaj moze
{
	*(sp + 3) = '\0';
	sp = globalString;
}

void modifyString4(const char* const sp)//i pokazivac i sadrzaj su konstanti pa se ne mogu menjati
{
	sp = globalString;
	*(sp + 3) = '\0';
}
